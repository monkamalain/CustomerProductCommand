...
//            log.info("Entity Created");
    ...
    public ResponseEntity<Optional<ProductDto>> getProductByRef(@PathVariable(value = "ref", required = true) String ref) {
        if(productService.getProductByRef(ref).isPresent()) {
//            log.info("Entity existed");
    ...
    public ResponseEntity<ProductDto> patiallyUpdateProduct(@PathVariable(value = "ref", required = true) String ref, @Valid @RequestBody ProductDto productDto) {
        if((productService.getProductByRef(productDto.getRefProduct()).isPresent())) {
//            log.info("Entity update patially");
    ...
    public ResponseEntity<ProductDto> totalyUpdateProduct(@PathVariable(value = "ref", required = true) String ref, @Valid @RequestBody ProductDto productDto) {
...
//            log.info("Entity update totally");
    ...
    public ResponseEntity<Optional<ProductDto>> deleteProductByRef(@PathVariable(value = "ref", required = true) String ref) {
...
//            log.info("Entity Deleted");
    ...
    public ResponseEntity<List<ProductDto>> getAllProductsAvailable(@PathVariable(value = "state", required = true) String state) {
    ...
    public ResponseEntity<List<ProductDto>> getAllProductsUnavailable(@PathVariable(value = "state", required = true) String state) {
        state = state.toUpperCase();
    ...
    public ResponseEntity<Set<String>> getAllRefProduct() {
    ...
    public ResponseEntity<List<ProductDto>> getProductByPrice(@PathVariable(value = "price", required = true) double price) {
    ...
    public ResponseEntity<List<ProductDto>> getProductByPriceBetween(@PathVariable(value = "price1", required = true) double price1, @PathVariable(value = "price2", required = true) double price2) {
    ...
    public ResponseEntity<List<ProductDto>> getProductByCreationDate(@PathVariable(value = "creationDate", required = true) String creationDate) {
    ...
    public ResponseEntity<List<ProductDto>> getProductBySaleDate(@PathVariable(value = "saleDate", required = true) String saleDate) {
    ...
    public ResponseEntity<Double> getProductBySaleDateAndPrice(@PathVariable(value = "saleDate1", required = true) String saleDate1, @PathVariable(value = "saleDate2", required = true) String saleDate2) {
